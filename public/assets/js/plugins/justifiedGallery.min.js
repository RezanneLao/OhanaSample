    ...
    JustifiedGallery.prototype.flushRow = function(isLastRow) {
        ...
        if (this.maxRowHeight) {
            if (
                ...
                this.maxRowHeight.value * settings.rowHeight < this.buildingRow.height
            ) {
                this.buildingRow.height = this.maxRowHeight.value * settings.rowHeight;
            } else if (
                this.maxRowHeight.value >= settings.rowHeight &&
    ...
    JustifiedGallery.prototype.retrieveMaxRowHeight = function() {
        ...
        if ($.type(this.settings.maxRowHeight) === "string") {
            if (this.settings.maxRowHeight.match(/^[0-9]+%$/)) {
                newMaxRowHeight.value =
                    parseFloat(this.settings.maxRowHeight.match(/^([0-9]+)%$/)[1]) / 100;
        ...
        return this.each(function(index, gallery) {
            ...
            if (typeof controller === "undefined") {
                ...
                controller = new JustifiedGallery(
                    $gallery,
                    $.extend({}, $.fn.justifiedGallery.defaults, arg)
                );
